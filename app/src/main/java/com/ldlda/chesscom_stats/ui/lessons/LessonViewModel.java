...
public class LessonViewModel extends AndroidViewModel {
    ...
    private static List<Lesson> setupLessonList() {
        ...
        lessonsList.add(new Lesson("Lesson 2", R.string.lesson2_desc, "Intermediate", R.drawable.lesson_2, 0xffa7c56a));
        lessonsList.add(new Lesson("Lesson 3", R.string.lesson3_desc, "Intermediate", R.drawable.lesson_3, 0xffe42c3c));
